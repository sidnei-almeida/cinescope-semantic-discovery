    ...
    <section id="data" className="info-section" aria-labelledby="data-title">
      ...
      <div className="info-section__body">
        <p className="info-section-lead">
          The semantic API returns lean recommendation candidates: <code>movie_id</code>,{" "}
          <code>similarity_score</code>, and titles. CineScope then uses TMDb as an
          enrichment layer to turn those candidates into a cinematic discovery interface.
        </p>
